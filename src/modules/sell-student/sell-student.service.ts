  ...
  async getPerformance(query) {
    ...
    const data = await this.sellStudent.findAll({
      ...
      attributes: [
        ...
        [
          Sequelize.fn('SUM', Sequelize.col('SellStudent.trial_class_count')),
          'trial_class_count_sum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.col('SellStudent.trial_class_scheduling_test'),
          ),
          'trial_class_scheduling_test_sum',
        ],
        [
          Sequelize.fn('SUM', Sequelize.col('SellStudent.formal_class_test')),
          'formal_class_test_sum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 1 THEN total_lessons ELSE 0 END',
            ),
          ),
          'omTotalLessonsSum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 1 THEN total_amount ELSE 0 END',
            ),
          ),
          'omTotalAmountSum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 2 THEN total_lessons ELSE 0 END',
            ),
          ),
          'fTotalLessonsSum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 2 THEN total_amount ELSE 0 END',
            ),
          ),
          'fTotalAmountSum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 3 THEN total_lessons ELSE 0 END',
            ),
          ),
          'zTotalLessonsSum',
        ],
        [
          Sequelize.fn(
            'SUM',
            Sequelize.literal(
              'CASE WHEN SellStudent.course_category = 3 THEN total_amount ELSE 0 END',
            ),
          ),
          'zTotalAmountSum',
        ],
